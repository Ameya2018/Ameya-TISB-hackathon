...
def func(gpa, satm , sate, act):
    ...
    payload={}
    headers = {
    'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NzYwNDE0NzUsImlhdCI6MTY3NTQzNjY3NSwianRpIjoiNDEwZGQwZGUtY2EzMC00YTE4LThlMWYtNjdiNTZiZGE2YWZmIiwic2NvcGUiOiIiLCJzdWIiOiIyMDA3NzU3ODQifQ.sGLE8zzoOB5Wxt7laBwRhqpOWNffvUkWpBodU_qngwU',
